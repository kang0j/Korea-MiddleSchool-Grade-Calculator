function main () {
  ...
  if (!pr){
      ...
      var message = '지필 점수('+ts_v+') + 수행 점수('+ps+')='+result_process+"<br><br>A: 80점 이상 / B: 60점 이상 80점 미만 / C: 60점 미만<br>학업성적관리지침에 따라 소수 첫째 자리에서 반올림합니다.<br>자세한 사항은 하단 '서비스 이용 안내'를 참고해주세요."
